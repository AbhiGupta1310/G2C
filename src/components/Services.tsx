  ...
  const services = [
    {
      icon: '🟡',
      title: 'Cash for Gold',
      description: 'Get instant cash for your gold jewelry, coins, bars, and ornaments. We accept all forms of gold.',
      features: ['All Purity Levels', 'Instant Testing', 'Best Market Rates', 'No Melting Required'],
    ...
    },
    {
      ...
      description: 'Silver jewelry, coins, utensils, and artifacts - we buy all types of silver items at competitive rates.',
      features: ['Sterling Silver', 'Pure Silver', 'Antique Items', 'Bulk Purchases'],
    ...
    },
    {
      ...
      description: 'Professional diamond evaluation and purchasing. Certified gemologists ensure accurate pricing.',
      features: ['Certified Evaluation', 'All Cuts & Sizes', 'Loose & Set Diamonds', 'GIA Certified'],
    ...
    },
    {
      ...
      description: 'Rare coins, antique jewelry, and collectible items. We specialize in vintage and heritage pieces.',
      features: ['Rare Coins', 'Vintage Jewelry', 'Heritage Items', 'Collector Pieces'],
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto">
            Professional buying services for all types of precious metals and gems. Get the best value for your valuables with our transparent and certified process.
          </p>
        </div>
        ...
        <div className="reveal bg-gradient-to-r from-yellow-400/10 to-orange-400/10 border border-yellow-400/20 rounded-2xl p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg">Simple, transparent, and fast - get cash for your valuables in minutes</p>
          </div>
        ...
        <div className="text-center mt-12 reveal">
          <div className="bg-black border border-yellow-400/30 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <h4 className="text-2xl font-bold text-white mb-4">Ready to Get Cash?</h4>
            <p className="text-gray-400 mb-6">
              Visit our store today or call us for a free consultation. We're here to help you get the best value for your precious items.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() => window.open('https://wa.me/919876543210?text=Hi! I want to sell my valuables. Please assist.', '_blank')}
